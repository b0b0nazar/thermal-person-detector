...
# Paths
MODEL_PATH = 'result/flir_person_rtdetr-l/weights/best.pt'
IMG_DIR = 'data/raw/flir_adas/video/thermal_8_bit/'
VIDEO_OUTPUT = 'result/flir_person_rtdetr-l/qualitative_val/video_inference_demo_from_images.mp4'
...
for img_path in img_files:
    ...
    # Show frame
    cv2.imshow('RT-DETR Image Sequence Inference', frame)
    out.write(frame)
